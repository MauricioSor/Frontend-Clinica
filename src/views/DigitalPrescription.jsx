...
const DigitalPrescription = () => {
    ...
    const generatePDF = () => {
        ...
        html2canvas(input, { useCORS: true, scale: 2 }).then((canvas) => {
            ...
            pdf.save(`receta_clinica_${params.idPatient}.pdf`);
        }).catch((error) => {
    ...
    return (
        <Container >
            {
                load ? (<><Container ref={printRef}>
                    <h1 className='fs-1 text-center my-2'><u>Receta Clinica</u></h1>
                    <Container>
                        <h2 className='fs-2 text-center my-3' style={{ textAlign: "center" }}><b>Paciente</b></h2>
                        ...
                        <Container>
                            <h2 className='fs-2 text-center my-3' style={{ textAlign: "center" }}><b>Receta</b></h2>
                        </Container>
                        <Container className='d-flex'>
                        ...
                        <Container>
                            <h3 className='fs-2 text-center my-4' style={{ textAlign: "center" }}><b>Medico</b></h3>
                        </Container>
                        <Container className='d-flex'>
