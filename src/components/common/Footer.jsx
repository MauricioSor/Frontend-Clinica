            ...
            <Container className='bg-dark py-3 justify-content-center' fluid id="footer">
                <Row  className="justify-content-around align-items-center">
                    <Col lg={4} md={4} sm={12}  className="" style={{ maxWidth: 170, width: "100%" }}>
                        {idioma?
                        (<p className="text-white text-center texto">Scan this QR code with an smartphone!</p>):
                    ...
                    <Col  lg={4} md={4}  sm={12}>
                        {
                            idioma?
                            (<p className="text-light text-end" id="textoFooter">&copy; All rights reserveds- MauricioSor</p>):
                    ...
                    <Col lg={4} md={4} sm={12} >
                        <Container className="text-center">
                            {idioma?
                            (<p className="text-light  text-center" id="textoFooter">Social networks</p>):
